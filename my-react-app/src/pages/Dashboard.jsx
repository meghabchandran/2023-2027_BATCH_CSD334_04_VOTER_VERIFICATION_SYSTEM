    ...
    <div className="min-h-screen bg-gradient-to-b from-[#eef1fa] via-[#f3f4f8] to-[#e6e9f5] px-4 py-6 sm:px-6">
      ...
      <div className="max-w-6xl mx-auto bg-[#eef1fa] rounded-3xl p-5 sm:p-6 space-y-5 sm:space-y-6 border border-[#d8dced]">
        ...
        <section className="bg-[#d1e3dd]/70 rounded-2xl p-6 border border-[#cddfd8]">
          ...
          <h2 className="text-lg font-semibold text-[#32292f] tracking-tight mb-4">
            Booth Details
          </h2>
        ...
        <section className="bg-white rounded-2xl border border-[#d8dced] p-6 shadow-sm hover:shadow-md transition">
          ...
          <div className="space-y-4">
            {mockCandidates.map((candidate) => (
              <div
                key={candidate.id}
                className="flex items-center justify-between bg-[#f7f8fc] p-4 rounded-xl border border-[#e2e5f2] hover:bg-[#eef1fa] hover:shadow-sm transition"
              >
                {/* LEFT SIDE */}
