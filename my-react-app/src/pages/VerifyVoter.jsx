...
function AccentBar() {
  return (
    ...
    >
      <div
        style={{ width: 28, height: 3, borderRadius: 2, background: "#0353A4" }}
      />
      <div
        style={{ width: 8, height: 3, borderRadius: 2, background: "#B9D6F2" }}
      />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <span
        style={{
          fontSize: 9,
          color: active || done ? "#0353A4" : "#8096B0",
          fontWeight: 600,
          letterSpacing: ".06em",
          textTransform: "uppercase",
          fontFamily: "'DM Mono',monospace",
...
export default function VerifyVoter() {
  ...
  const addRipple = (e) => {
    ...
    setRipples((r) => [
      ...r,
      { id, x: e.clientX - rect.left - 35, y: e.clientY - rect.top - 35 },
    ]);
  ...
  const startCamera = async (e) => {
    ...
    try {
      ...
      showMessage(
        "Camera ready — position your face clearly in the frame",
        "info",
      );
    } catch {
      showMessage(
    ...
    return (
      <>
        ...
        <div
          ...
          style={{
            minHeight: "100vh",
            background: "linear-gradient(135deg,#EBF3FB,#B9D6F2)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
    ...
    <>
      ...
      <div
        ...
        style={{
          minHeight: "100vh",
          background:
            "linear-gradient(135deg,#EBF3FB 0%,#D6E9F8 55%,#B9D6F2 100%)",
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          >
            ...
            <div
              style={{
                ...
                alignItems: "center",
                gap: 6,
                background: "rgba(3,83,164,.08)",
                border: "1px solid rgba(3,83,164,.16)",
                borderRadius: 20,
                padding: "5px 14px",
              }}
            >
          ...
          <div
            style={{
              ...
              border: "1.5px solid rgba(3,83,164,.16)",
              borderRadius: 20,
              overflow: "hidden",
              boxShadow: "0 4px 32px rgba(3,83,164,.10)",
          ...
          >
              ...
              >
                <div
                  style={{
                    ...
                    boxShadow: "0 2px 12px rgba(3,83,164,.25)",
                  }}
                >
                  {voter.name
                    ?.split(" ")
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  <div
                    style={{
                      background: "rgba(3,83,164,.08)",
                      border: "1px solid rgba(3,83,164,.18)",
                      borderRadius: 7,
                      padding: "3px 10px",
                      fontFamily: "'DM Mono',monospace",
                      fontSize: 12,
            ...
            >
              ...
              <InfoRow
                icon="👨"
                label="Father's Name"
                value={voter.fathers_name}
                delay=".12s"
              />
              <InfoRow
                icon="💍"
                label="Spouse"
                value={voter.spouse_name}
                delay=".15s"
              />
              <InfoRow
                icon="⚧"
              ...
              <InfoRow
                icon="🗳️"
                label="Has Voted"
                value={voter.has_voted ? "Yes — Recorded" : "No — Eligible"}
                delay=".33s"
              />
            </div>
            ...
            <div
              style={{
                height: 1,
                background:
                  "linear-gradient(90deg,transparent,rgba(3,83,164,.14),transparent)",
                margin: "8px 28px",
              }}
            />
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  <button
                    ...
                    style={{
                      ...
                      border: "1.5px solid rgba(3,83,164,.25)",
                    }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.background = "rgba(3,83,164,.06)")
                    }
                    onMouseLeave={(e) =>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: "0 4px 16px rgba(3,83,164,.30)",
                    }}
                  >
                    🔍 Go to Search Page
                  </button>
            ...
            alreadyVoted ? (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      is disabled and this attempt has been logged.
                    </p>
                  </div>
                </div>
                <div style={{ display: "flex", gap: 10 }}>
              ...
              <div style={{ padding: "20px 28px 28px" }}>
                ...
                >
                  ...
                  <div
                    style={{
                      flex: 1,
                      height: 2,
                      background: `linear-gradient(90deg,${step > 1 ? "#0353A4" : "rgba(3,83,164,.15)"},${step > 2 ? "#0353A4" : "rgba(3,83,164,.15)"})`,
                  ...
                  <div
                    style={{
                      flex: 1,
                      height: 2,
                      background: `linear-gradient(90deg,${step > 2 ? "#0353A4" : "rgba(3,83,164,.15)"},rgba(3,83,164,.15))`,
                      transition: "background .4s",
                    }}
                  />
                  <Step
                ...
                {/* Camera frame */}
                <div
                  className={`vv-camera-frame ${cameraActive ? (capturedImage ? "captured" : "active") : ""}`}
                  style={{
                    marginBottom: 16,
                    background: "#061A40",
                    minHeight: 200,
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      color: "#0353A4",
                      background: "rgba(3,83,164,.08)",
                      border: "1.5px solid rgba(3,83,164,.22)",
                    }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.background = "rgba(3,83,164,.14)")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.background = "rgba(3,83,164,.08)")
                    }
                  >
                    {ripples.map((r) => (
                      <span
                    ...
                    style={{
                      ...
                      background:
                        capturedImage && !verifying
                          ...
                          : "rgba(3,83,164,.30)",
                      cursor:
                        capturedImage && !verifying ? "pointer" : "not-allowed",
                      boxShadow:
                        capturedImage && !verifying
                          ? "0 4px 16px rgba(3,83,164,.30)"
                          : "none",
                    }}
                  >
                    {verifying ? (
