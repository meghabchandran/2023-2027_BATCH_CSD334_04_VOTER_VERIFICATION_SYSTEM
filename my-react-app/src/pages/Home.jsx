  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "22px 20px",
        borderRadius: 18,
        boxShadow: "0 20px 60px rgba(3,83,164,0.13)",
      }}
    >
      <div className="anim-slideUp d1">
        ...
        >
          Reach out to the Election Commission through any channel below.
        </p>
      </div>
          ...
          <div key={i} className="contact-row">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {c.href ? (
                ...
                <span
                  style={{ color: "#061A40", fontWeight: 600, fontSize: 12 }}
                >
                  {c.value}
                </span>
              )}
      ...
      >
        ...
        >
          For <strong>polling day emergencies</strong> — call the hotline
          immediately and notify your Presiding Officer.
        </p>
      </div>
      <button
        onClick={onBack}
...
export default function Home() {
  ...
  const panel = {
    about: {
      ...
      sub: "Real-time duplicate vote detection powered by facial recognition.",
    },
    welcome: {
      badge: "SECURE ACCESS",
      heading: (
  ...
  const features = [
    {
      ...
      desc: "Instant biometric matching against registered voter records.",
    },
    {
      icon: "🗳️",
      title: "One Person, One Vote",
      desc: "System permanently flags the voter after verification.",
    },
    {
      icon: "⚡",
      title: "Real-Time Detection",
      desc: "Cross-references every scan against live voted registry.",
    },
    {
      icon: "🔒",
      title: "Officer Authentication",
      desc: "Only authorised officers can access verification terminals.",
    },
  ];
    ...
    <>
      ...
      >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                >
                  ELECTION COMMISSION OF INDIA · AI-POWERED
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button
                className="nav-link nav-help-btn"
        ...
        <div className="main-grid">
          {/* LEFT HERO */}
          <div
            className="scanline-wrap hero-panel"
            style={{
              background: "#003559",
              position: "relative",
              overflow: "hidden",
          ...
          >
            ...
            >
              ...
              <h2
                className="anim-slideUp d2 hero-heading"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 800,
                  color: "white",
              ...
              <AccentBar />
              <p
                className="anim-slideUp d3 hero-sub"
                style={{
              ...
              <div className="anim-slideUp d4 stats-grid">
                {stats.map(({ val, label, icon }) => (
                  <div key={label} className="stat-tile">
                    <span className="stat-icon" style={{ fontSize: 18 }}>
                      {icon}
                    </span>
                    <div>
                      <div
              ...
              <div
                className="anim-slideUp d5 hero-tags"
                style={{
                  display: "flex",
                  gap: 6,
                  flexWrap: "wrap",
          ...
          >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11, color: "#6B80A0" }}>
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: 11,
                          flexShrink: 0,
                          background: "linear-gradient(135deg,#003559,#0353A4)",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          fontSize: 19,
                  ...
                  >
                    ...
                    >
                      Secured with{" "}
                      <strong style={{ color: "#0353A4" }}>
                        AES-256 encryption
                      </strong>
                      . Authorised officers only. Sessions are logged and
                      audited.
                    </p>
                  </div>
            ...
            {view === "about" && (
              <div
                key="about"
                className="anim-card right-panel-inner"
                style={{
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                <div className="anim-slideUp d1" style={{ marginBottom: 14 }}>
                  ...
                  >
                    ...
                    uphold electoral integrity across every polling booth in
                    India.
                  </p>
                </div>
                <div className="divider" />
        ...
        >
          <div
            className="footer-inner footer-pad"
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
              ...
              <span style={{ fontSize: 10.5, color: "rgba(185,214,242,0.4)" }}>
            ...
            >
              <span style={{ fontSize: 10.5, color: "rgba(185,214,242,0.35)" }}>
            ...
            <div className="footer-right-alt">
              <PulseDot color="#4ade80" size={6} />
