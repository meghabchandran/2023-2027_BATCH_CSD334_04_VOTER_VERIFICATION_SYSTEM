...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .glass-card:hover { box-shadow: 0 20px 60px rgba(3,83,164,0.13); }
...
.divider { 
  height: 1px; 
  background: linear-gradient(90deg, transparent, rgba(3,83,164,0.18), transparent); 
  margin: 6px 0;  /* was 10px 0 */
}
  .badge-pill {
  ...
  .contact-row a { color: #0353A4; text-decoration: none; font-weight: 600; font-size: 13px; word-break: break-all; }
  ...
  .vvs-right::-webkit-scrollbar { display: none; }
.vvs-right { -ms-overflow-style: none; scrollbar-width: none; }
.feature-grid {
  ...
  .vvs-footer {
    background: #061A40;
    border-top: 1px solid rgba(185,214,242,0.08);
    padding: 13px 40px;
  ...
  @media (max-width: 1024px) {
    .vvs-main-grid { grid-template-columns: 1fr; }
    .vvs-hero { min-height: 300px; align-items: center; }
    .vvs-hero-content { padding: 28px 32px !important; }
    .vvs-hero h2 { font-size: 32px !important; }
  ...
  @media (max-width: 640px) {
    .vvs-navbar-inner { padding: 0 16px !important; height: 56px !important; }
    .vvs-brand-title  { font-size: 13px !important; }
    .nav-clock        { display: none !important; }
    .nav-subtitle     { display: none; }
    .vvs-hero         { min-height: 240px; }
    .vvs-hero-content { padding: 20px 20px 32px !important; }
    .vvs-hero h2      { font-size: 24px !important; }
    .badge-pill       { font-size: 9px; padding: 3px 10px; }
    .tags-row         { display: none !important; }
    .stat-tile        { padding: 9px 10px; }
    .vvs-right-inner  { padding: 20px 16px !important; }
    .feature-grid     { grid-template-columns: 1fr; gap: 10px; }
    .flow-grid        { grid-template-columns: 1fr 1fr; gap: 8px; }
    .flow-connector   { display: none; }
    .vvs-footer       { flex-direction: column; gap: 8px; padding: 12px 16px; text-align: center; }
    .footer-right     { gap: 10px; flex-wrap: wrap; justify-content: center; }
    .glass-card       { padding: 20px 16px !important; }
    .help-card-wrap   { padding: 20px 16px !important; }
    .role-panel-wrap  { padding: 20px 16px !important; }
  }
`;
...
function AccentBar() {
  return (
    ...
    >
      <div
        style={{ width: 44, height: 3, borderRadius: 2, background: "#0353A4" }}
      />
      <div
        style={{ width: 14, height: 3, borderRadius: 2, background: "#B9D6F2" }}
      />
      <div
        style={{
          width: 6,
  ...
  return (
    ...
    >
      <div className="anim-slideUp d1">
        ...
        >
          Facing an issue? Reach out to the Election Commission through any
          channel below.
        </p>
      </div>
      <div className="divider" />
      <div
        className="anim-slideUp d2"
        style={{
          display: "flex",
          ...
          <div key={i} className="contact-row">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {c.href ? (
                ...
                <span
                  style={{ color: "#061A40", fontWeight: 600, fontSize: 13 }}
                >
                  {c.value}
                </span>
              )}
              <div style={{ fontSize: 11, color: "#9BAABB", marginTop: 2 }}>
                {c.sub}
              </div>
            </div>
          </div>
      ...
      <div className="divider" />
      <div
        className="anim-slideUp d3"
        style={{
          background: "rgba(3,83,164,0.06)",
          border: "1px solid rgba(3,83,164,0.13)",
          borderRadius: 12,
          padding: "11px 14px",
          marginBottom: 18,
          display: "flex",
      ...
      >
        ...
        >
          For <strong>polling day emergencies</strong> — outages or duplicate
          fraud — call the hotline immediately and notify your Presiding
          Officer.
        </p>
      </div>
      <button
    ...
    about: {
      ...
      heading: (
        <>
          One Person.
          <br />
          <span style={{ color: "#B9D6F2" }}>One Vote.</span>
        </>
      ),
      sub: "Real-time duplicate vote detection powered by facial recognition technology.",
    },
    welcome: {
      badge: "SECURE ACCESS",
      heading: (
        <>
          Select
          <br />
          <span style={{ color: "#B9D6F2" }}>Your Role</span>
        </>
      ),
      sub: "Access your dashboard and manage booth operations with full confidence.",
    },
    help: {
      ...
      heading: (
        <>
          We're Here
          <br />
          <span style={{ color: "#B9D6F2" }}>to Help.</span>
        </>
      ),
      sub: "Contact our helpdesk for technical support, access issues, or emergencies.",
    },
  }[view];
  ...
  const features = [
    {
      ...
      desc: "Instant biometric matching against all registered voter records in milliseconds.",
    },
    {
      icon: "🗳️",
      title: "One Person, One Vote",
      desc: "Once verified, the system permanently flags the voter preventing any re-entry.",
    },
    {
      icon: "⚡",
    ...
    },
    {
      ...
      desc: "Only authorised election officers can access and operate verification terminals.",
    },
  ];
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          flexDirection: "column",
          background:
            "linear-gradient(148deg, #EBF3FB 0%, #D6E9F8 50%, #C0D9F4 100%)",
        }}
      >
        {/* ══ NAVBAR ══ */}
        <nav
          style={{
            background: "#061A40",
            boxShadow: "0 2px 28px rgba(6,26,64,0.55)",
            position: "relative",
            zIndex: 50,
          }}
        >
          <div
            className="vvs-navbar-inner"
            style={{
              maxWidth: 1400,
              margin: "0 auto",
              padding: "0 32px",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div
                style={{
                  ...
                  height: 40,
                  background:
                    "linear-gradient(135deg, #0353A4 0%, #006DAA 100%)",
                  borderRadius: 11,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: "0 3px 14px rgba(3,83,164,0.6)",
                  flexShrink: 0,
                }}
              >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button
                className="nav-link"
                onClick={() => setView(view === "help" ? "about" : "help")}
                style={{
                  fontSize: 13,
                  fontWeight: 500,
                  padding: "8px 13px",
                  borderRadius: 8,
                  color: view === "help" ? "#B9D6F2" : "rgba(255,255,255,0.65)",
                }}
              >
                {view === "help" ? "← Home" : "Help"}
              </button>
        ...
        {/* ══ MAIN ══ */}
        <div className="vvs-main-grid">
          {/* LEFT HERO */}
          <div className="scanline-wrap vvs-hero">
            <img
              src={homeImage}
              alt=""
              style={{
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(162deg, rgba(6,26,64,0.48) 0%, rgba(0,53,89,0.82) 55%, rgba(6,26,64,0.98) 100%)",
              }}
            />
            ...
            >
              ...
              <div
                className="anim-slideUp d5 tags-row"
          ...
          <div className="vvs-right">
              ...
              >
                ...
                >
                  <div className="anim-slideUp d1">
                    ...
                    >
                      Choose your officer type to securely access your
                      dashboard.
                    </p>
                  </div>
                  <div className="divider" />
                  ...
                  >
                    <button
                      ...
                      onClick={() => {
                        window.location.href = "/login-data-entry";
                      }}
                    >
                      <div
                        style={{
                          ...
                          fontSize: 21,
                          flexShrink: 0,
                          boxShadow: "0 4px 14px rgba(3,83,164,0.32)",
                        }}
                      >
                        📋
                      </div>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: "#6B80A0" }}>
                          Voter registration &amp; records management
                        </div>
                      </div>
                      <div
                        style={{
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: 13,
                          background:
                            "linear-gradient(135deg, #003559, #0353A4)",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          fontSize: 21,
                          flexShrink: 0,
                          boxShadow: "0 4px 14px rgba(0,53,89,0.32)",
                        }}
                      >
                        🗳️
                      </div>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: "#6B80A0" }}>
                          Polling booth voter verification
                        </div>
                      </div>
                      <div
                        style={{
                  ...
                  >
                    ...
                    >
                      Authorised election officers only. All sessions are
            ...
            {view === "about" && (
              <div
                key="about"
                className="anim-card vvs-right-inner"
                style={{
                  flex: 1,
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                <div className="anim-slideUp d1" style={{ marginBottom: 12 }}>
                  ...
                  >
                    The{" "}
                    <strong style={{ color: "#061A40" }}>
                      Voter Verification System
                    </strong>{" "}
                    uses real-time facial recognition and duplicate-detection to
                    uphold electoral integrity across every polling booth.
                  </p>
                </div>
                ...
                <div className="anim-slideUp d2 feature-grid">
                  {features.map(({ icon, title, desc }) => (
                    <div key={title} className="feature-card">
                      <div style={{ fontSize: 26, marginBottom: 11 }}>
                        {icon}
                      </div>
                      <div
                        style={{
                ...
                <div className="anim-slideUp d3" style={{ marginBottom: 12 }}>
                  <div
                    style={{
                      fontSize: 10,
                      fontWeight: 700,
                    ...
                    {[
                      {
                        n: "01",
                        t: "Officer Logs In",
                        d: "Authenticated via secure credentials.",
                        icon: "🔑",
                      },
                      {
                        n: "02",
                        t: "Voter Face Scan",
                        d: "Camera captures biometric data.",
                        icon: "📷",
                      },
                      {
                        n: "03",
                        t: "Registry Match",
                        d: "Cross-checks national voter database.",
                        icon: "🔍",
                      },
                      {
                        n: "04",
                        t: "Vote Recorded",
                        d: "Duplicates blocked instantly.",
                        icon: "✅",
                      },
                      ...
                      >
                        {i < arr.length - 1 && (
                          <div
                            ...
                            style={{
                              ...
                              height: 1,
                              background:
                                "linear-gradient(90deg, rgba(3,83,164,0.25), rgba(3,83,164,0.08))",
                              zIndex: 0,
                            }}
                          />
                        )}
                        <div
                          style={{
                            ...
                            borderRadius: 12,
                            background: "rgba(3,83,164,0.09)",
                            border: "1.5px solid rgba(3,83,164,0.22)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontSize: 18,
                ...
                <div
                  ...
                  style={{
                    ...
                    paddingTop: 10,
                    borderTop: "1px solid rgba(3,83,164,0.1)",
                    gap: 10,
                  }}
                >
                  <button
        ...
        <footer className="vvs-footer">
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            >
              © 2026 Election Commission of India · Voter Verification System
            </span>
          </div>
