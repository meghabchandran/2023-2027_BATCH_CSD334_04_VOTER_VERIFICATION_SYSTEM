...
function AccentBar() {
  return (
    <div className="flex items-center gap-2 mb-1">
      <div
        style={{ width: 36, height: 3, borderRadius: 2, background: "#0353A4" }}
      />
      <div
        style={{ width: 10, height: 3, borderRadius: 2, background: "#B9D6F2" }}
      />
    </div>
  );
}
...
function FeatureItem({ icon, title, desc, delay }) {
  return (
    <div
      className={`feature-row flex items-start gap-3 px-3 py-2.5 animate-fadeSlideIn ${delay}`}
    >
      <div
        style={{
          width: 32,
...
function LoginDropdown({ dropUp = false }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      >
        Login
        <span className="login-dropdown-arrow" style={{ fontSize: 10 }}>
          ▼
        </span>
      </button>
  ...
  return (
    ...
    >
      <div className="animate-slideUp delay-1">
        ...
        >
          Facing an issue? Reach out to the Election Commission support team
      ...
      <div
        style={{
          height: 1,
          background:
            "linear-gradient(90deg, transparent, rgba(3,83,164,0.2), transparent)",
          marginBottom: 10,
        }}
      />
      ...
      {/* Emergency notice */}
      <div
        className="animate-slideUp delay-3"
        style={{
          background: "rgba(3,83,164,0.06)",
      ...
      >
        ...
        >
          For <strong>polling day emergencies</strong> such as system outages or
          duplicate vote fraud, call the hotline immediately and notify your
          Presiding Officer.
        </p>
      </div>
    ...
    about: {
      ...
      heading: (
        <>
          How the
          <br />
          <span style={{ color: "#B9D6F2" }}>System Works</span>
        </>
      ),
      sub: "Biometric-grade facial recognition ensures every voice counts — exactly once.",
    },
    help: {
      ...
      sub: "Contact our helpdesk for technical support, access issues, or on-ground emergencies.",
    },
  };
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1 md:gap-2">
            ...
            <button
              onClick={() => setView(view === "about" ? "welcome" : "about")}
              className="nav-link"
              style={{
                background: "none",
                border: "none",
                cursor: "pointer",
                color: view === "about" ? "#B9D6F2" : "rgba(255,255,255,0.8)",
                fontSize: 13,
                fontWeight: 500,
                padding: "8px 12px",
                borderRadius: 6,
            ...
            <button
              onClick={() => setView(view === "help" ? "welcome" : "help")}
              className="nav-link"
              style={{
                background: "none",
                border: "none",
                cursor: "pointer",
                color: view === "help" ? "#B9D6F2" : "rgba(255,255,255,0.6)",
                fontSize: 13,
                fontWeight: 400,
                padding: "8px 12px",
                fontFamily: "'Inter', sans-serif",
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(160deg, rgba(6,26,64,0.55) 0%, rgba(0,53,89,0.85) 60%, rgba(6,26,64,0.97) 100%)",
              }}
            />
            <div
              style={{
                ...
                inset: 0,
                backgroundImage:
                  "linear-gradient(rgba(185,214,242,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(185,214,242,0.04) 1px, transparent 1px)",
                ...
                <div className="animate-slideUp delay-1">
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 700, color: "#061A40" }}>
                      Voter Verification System with Real-Time Duplicate Vote
                      Detection
                    </span>{" "}
                    utilizes facial recognition technology to maintain electoral
                    integrity across all booths.
                  </p>
                </div>
                <div
                  style={{
            ...
            {view === "welcome" && (
              ...
              >
                <div className="animate-slideUp delay-1">
                  ...
                  >
                    Secure access point for election officers to manage booth
                    operations and verify voter identities in real-time.
                  </p>
                </div>
                ...
                <div className="animate-slideUp delay-3">
                  ...
                  >
                    <button
                      ...
                      onClick={() =>
                        navigate("/login-data-entry", { replace: true })
                      }
                      style={{
                        width: "100%",
                        background: "#0353A4",
                  ...
                  >
                    Authorized election officers only · Secured with end-to-end
                    encryption
                  </p>
                </div>
                ...
                >
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = "rgba(3,83,164,0.13)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = "rgba(3,83,164,0.07)";
                    }}
                  >
                    ❓ Need Help?
                  </button>
        ...
        >
          <span style={{ fontSize: 11, color: "#7090B0" }}>
            © 2026 Election Commission · Voter Verification System
          </span>
          <span
            style={{
              fontSize: 11,
